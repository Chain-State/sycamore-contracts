cardano-cli transaction build \
    ...
    --change-address $(cat ../afia-validation/ap-script.addr) \
    --tx-out $(cat ../preview-wallets/wallet1/payment.addr)+" 1 bcf896fe5c1dbb10dcce8d2ec557492d407450c44e8bdbcdb9db7812.41666961233031" \
    --tx-out $(cat ../afia-validation/ap-script.addr)+97822003 \
